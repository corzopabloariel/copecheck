<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active">Portadores</li>
  </ol>
</nav>
<section class="">
	<div class="container-fluid d-flex justify-content-center">
		<div class="flex__body col-12">
			<table id="portadores" class="table table-striped table-hover flex__table" style="width: 100%"></table>
		</div>
	</div>
</section>
...
userBean.listarEntidad = function(col,res,target){
  ...
  var tabla = $("#"+target).DataTable({
      ...
      "buttons": [
          {
            text: '<i class="fas fa-plus"></i> Portador',
            className: 'btn-info',
    ...
    Abtn.push({"nombre":"Cancelar","onclick":"","class":"btn btn-danger"});
		// PYRUS
    _p = new Pyrus("portadores");
    _p.constructor();
    _p.listador("portadores");

    _p.editor("#modal","Nuevo portador",Abtn);
	}
